...
class ApiManager(
    endPoint: String,
    var tokenType: ApiTokenType? = null,
    var contentType: ApiContentType? = ApiContentType.JSON
                    ...
                    requestBuilder = chain.request().newBuilder()
                        .apply {
                            when (tokenType) {
                                ...
                                ApiTokenType.PRIVATE -> {
                                    this.addHeader("Authorization", "${AuthStorage.getToken()}")
                                }
                            }
                        }

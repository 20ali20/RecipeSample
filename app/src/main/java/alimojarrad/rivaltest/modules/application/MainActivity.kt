package alimojarrad.rivaltest.modules.application

import alimojarrad.rivaltest.BaseRouter
import alimojarrad.rivaltest.R
import alimojarrad.rivaltest.modules.recipe.RecipeFragment
...
class MainActivity : BaseActivity(), BaseRouter {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        display(RecipeFragment.newInstance())
